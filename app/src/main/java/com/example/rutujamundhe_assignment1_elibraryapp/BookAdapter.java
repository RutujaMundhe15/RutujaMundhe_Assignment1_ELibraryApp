...
// This class represents the custom adapter for the book GridView in the application.
...
public class BookAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            // If the view is null, inflate the layout for a book item.
        ...
        // Add an OnCheckedChangeListener to the CheckBox to handle book checked and unchecked.
